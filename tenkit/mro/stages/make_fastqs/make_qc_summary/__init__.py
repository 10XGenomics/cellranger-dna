...
def main(args, outs):
    ...
    for idx, r1f in enumerate(r1_files):
        ...
        outs.summary_chunk['read1'].append(output_json_path)
    ...
    for idx, r2f in enumerate(r2_files):
        ...
        outs.summary_chunk['read2'].append(output_json_path)
    ...
    for sample, lane_dict in sorted(sample_dict.items()):
        ...
        for lane, chunks in sorted(lane_dict.items()):
            ...
            for chunk_arg, chunk_out in chunks:
                for barcode_file in chunk_out.summary_chunk['barcode']:
                ...
                for r1_file in chunk_out.summary_chunk['read1']:
                ...
                for r2_file in chunk_out.summary_chunk['read2']:
